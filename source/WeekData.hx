...
class WeekData
{
	...
	public static var songsNames:Array<Dynamic> = [
		['Tutorial'],
		['Distinctive', 'Outrage', 'Tabmoc-ssendas'],
		['Mysterious'],
		['Sadness', 'Ronk', 'Ronkshed', 'Jaws', 'Ball-torture']
	];
	...
	public static var weekNumber:Array<Dynamic> = [null, // Tutorial
		null, null, null];
	...
	public static var loadDirectory:Array<String> = ['tutorial', // Tutorial loads "tutorial" folder on assets/
		null];
	...
	public static var weekResetName:Array<String> = ["Tutorial", null];
